...
const backgrounds: { id: CharacterBackground; label: string; icon: React.ReactNode; desc: string; flavor: string }[] = [
  {
    ...
    desc: '+5 starting herbs, +1 bonus herb from every NPC',
  ...
  },
  {
    ...
    desc: '+15% XP from all sources, +3 starting knowledge scrolls',
  ...
  },
  {
    ...
    desc: '+1 starting Estra Bond, bonus XP & herbs from NPC conversations',
  ...
  },
  {
    ...
    desc: '+3 starting crystals, double scrolls & bonus bloom essence from shrines',
