...
const TitleScreen = ({ onStart }: TitleScreenProps) => {
  ...
  return (
    <motion.div
      ...
      style={{ background: 'radial-gradient(ellipse at 50% 60%, hsl(230 25% 14%), hsl(230 25% 4%))' }}
    ...
    >
      ...
      {/* Radial glow behind Estra */}
      <motion.div
        className="absolute rounded-full"
        style={{
          width: 300,
          height: 300,
          background: 'radial-gradient(circle, hsla(35 90% 55% / 0.15), transparent 70%)',
        }}
